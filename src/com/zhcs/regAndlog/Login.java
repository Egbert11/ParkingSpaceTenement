...
import com.zhcs.manage.CommunityManage;
		    ...
		    public void done(List<AVObject> avObjects, AVException e) {
		        if (e == null) {
		            ...
		            if(pass.equals(obj.getString("password"))) {
						...
						//设置小区的信息
						CommunityInfo.setId(obj.getObjectId());
						CommunityInfo.setAddress(obj.getString("address"));
						CommunityInfo.setUserName(obj.getString("userName"));
						CommunityInfo.setLatitude(obj.getNumber("latitude"));
						CommunityInfo.setLongitude(obj.getNumber("longitude"));

			            Toast.makeText(Login.this, "登陆成功", Toast.LENGTH_SHORT).show();
						Intent intent=new Intent(Login.this,CommunityManage.class);
